...
def train(train_loader, model, criterion, optimizer, epoch, device, args, log_file=None):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        loss_CLS.update(loss['cls'].item(), images.size(0))  #TO DO : add MSE loss to the AverageMeter
        loss_MSE.update(loss['mse'].item(), images.size(0))  #TO DO : add MSE loss to the AverageMeter
